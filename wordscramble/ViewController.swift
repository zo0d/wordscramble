        ...
        if isPossible(word: lowerAnswer) {
            if isOriginal(word: lowerAnswer) {
                if isReal(word: lowerAnswer) {
                    ...
                    showErrorMessage(title: "Invalid Word", message: "Miss me with that weak shit")
                }
            } else {
                showErrorMessage(title: "Repeat Word", message: "Zero originality")
            }
        } else {
            showErrorMessage(title: "Word Not Possible", message: "\(answer.capitalized)? Do you even English?")
        }
    }
